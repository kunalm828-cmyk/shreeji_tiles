...
export const metadata = {
  ...
  keywords: [
    ...
    'luxury kitchen backsplash', 'premium sink area tiles', 'restaurant kitchen wall tiles',
    'cafe interior flooring', 'premium modular kitchen tiles', 'stain resistant kitchen tiles'
  ],
};
